...
[![Lines of Code](https://img.shields.io/endpoint?url=https%3A%2F%2Fvs.pl3x.net%2Fshields.io%2Floc.php)](https://github.com/BillyGalbreath/VS-LiveMap)
...
LiveMap is a Google Maps-like map for your Vintage Story server that can be viewed in a browser. Easy to set up when making use of LiveMap's integrated webserver which works out-of-the-box, while also available to be integrated into existing websites running on Apache and the like.
